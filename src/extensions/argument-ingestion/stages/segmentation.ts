...
Assign each segment a short stable id like "s1", "s2", ... in left-to-right order, copy the segment's text verbatim (no rewriting), and record the character span (start inclusive, end exclusive) into the input. Whitespace between segments is owned by neither segment.
