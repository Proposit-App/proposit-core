...
citation/axiom connection schemata, plus a parser overhaul that moves
support-graph information from a separate `citationMiniIds` field to
formula-derived inference. No state-shape change.
