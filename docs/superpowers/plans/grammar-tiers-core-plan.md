...
>
> **Phase D remaining work after D2b (complete):**
>
> - **D3 (next-up)** — Verify no `LOAD_GRAMMAR` / `STRICT_GRAMMAR` references remain (the file carrying them was deleted in D2's `f32516b`; verify and document). Quick sanity pass.
